...
type: kb
date: 2017-02-01
description: Mit dem Befehl `hugo new theme` werden die Anfänge eines neuen Themas eingerüstet, damit Sie sich auf den Weg machen können.
slug: design-erstellen
weight: 6
categories:
  - Usage
---
...
Wenn Sie ein Thema mit der Absicht erstellen, es mit der Community zu teilen, verwenden Sie relative URLs, da Benutzer Ihres Themas möglicherweise nicht im Stammverzeichnis ihrer Website veröffentlichen.
{{% /notice %}}
